...
// delete user and all data in connections with them
exports.deleteUser = async (req, res, next) => {
  ...
  try {
    ...
    // if matches delete matches first in both users
...
exports.logoutUser = async (req, res, next) => {
  delete req.headers['auth']; // remove the headers so auth will not work
